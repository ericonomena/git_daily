...
<!-- Mirrored from dompet.dexignlab.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Aug 2023 15:03:35 GMT -->
<head>
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
				<img src="images/oasis/i-oasis-tp_cleanup-removebg-preview__1_-removebg-preview.png" style="height: 103px;width: 120px;">
                <h3><span style="font-size: 2em;color: #F6A42D">i</span><strong>-oasis</strong></h3>
            </a>
            ...
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="fa-solid fa-calendar fw-bold"></i>
							<span class="nav-text">Repport</span>
						</a>
					...
					<li>
						<a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="fa-solid fa-user-tie fw-bold"></i>
							<span class="nav-text">Project Leaders</span>
						</a>
						<ul aria-expanded="false">
							<li><a href="/LeaderProjectList">all Leaders</a></li>  
						</ul>
					</li>

					<li>
						<a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="fa-solid fa-gears fw-bold"></i>
							<span class="nav-text">Email setup</span>
						</a>
						<ul aria-expanded="false">
							<li><a href="/emailCompose">Send an Email</a></li>
							<li><a href="/emailSetupList">Setup notification</a></li>
						</ul>
					</li>
					...
					<li>
                        ...
                        <ul aria-expanded="false" class="mm-collapse" style="">
							<li><a href="/TeamProjectList">add team</a></li>
						</ul>
                    </li>


					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="fa-solid fa-hourglass-start fw-bold"></i>
...
<!-- Mirrored from dompet.dexignlab.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Aug 2023 15:03:41 GMT -->
</html>